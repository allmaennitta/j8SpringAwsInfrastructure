...
@ContextConfiguration(classes = {JsonConfiguration.class, ProfileTest_prod.Config.class})
@ActiveProfiles("prod")
@DirtiesContext
public class ProfileTest_prod {
    private static final Logger LOG = LoggerFactory.getLogger(ProfileTest_prod.class);
    ...
    public void EXPECT_ResultsAreDeserializedCorrecty() {
        ...
        assertThat(resultToCheck.getFoo()).isEqualTo("prod-environment");
        assertThat(resultToCheck.getBar()).isEqualTo("PROD-ENV!");
